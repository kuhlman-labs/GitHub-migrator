...
CREATE INDEX IF NOT EXISTS idx_repositories_has_oversized_commits ON repositories(has_oversized_commits);
CREATE INDEX IF NOT EXISTS idx_repositories_has_long_refs ON repositories(has_long_refs);
CREATE INDEX IF NOT EXISTS idx_repositories_has_blocking_files ON repositories(has_blocking_files);
CREATE INDEX IF NOT EXISTS idx_repositories_has_large_file_warnings ON repositories(has_large_file_warnings);
