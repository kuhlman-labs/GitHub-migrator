...
ALTER TABLE github_teams ADD COLUMN source_id INTEGER REFERENCES sources(id);

-- Add source_id to github_users  
ALTER TABLE github_users ADD COLUMN source_id INTEGER REFERENCES sources(id);
