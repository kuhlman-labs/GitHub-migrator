...
ALTER TABLE team_mappings ADD COLUMN source_id INTEGER REFERENCES sources(id);

-- Add source_id to user_mappings  
ALTER TABLE user_mappings ADD COLUMN source_id INTEGER REFERENCES sources(id);
