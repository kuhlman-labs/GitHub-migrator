...
export const api = {
  ...
  getRepositoryELMStatus: repositoriesApi.getELMStatus,
  cutoverRepository: repositoriesApi.cutover,
  setRepositoryMigrationRoute: repositoriesApi.setMigrationRoute,
