...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-gh-canvas-default flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="bg-gh-canvas-subtle border border-gh-border-default rounded-lg p-8 shadow-lg">
          {/* GitHub Logo */}
          ...
          {/* Title */}
          <h1 className="text-2xl font-semibold text-gh-fg-default text-center mb-2">
            GitHub Migration Server
          </h1>
          <p className="text-gh-fg-muted text-center mb-8">
            Sign in to continue
          </p>

          {/* Authorization Requirements */}
          {hasRules && (
            <div className="mb-6 p-4 bg-gh-canvas-inset border border-gh-border-default rounded-md">
              <h3 className="text-sm font-semibold text-gh-fg-default mb-2">
                Access Requirements
              </h3>
          ...
          {/* Info Text */}
          <p className="mt-6 text-xs text-gh-fg-muted text-center">
